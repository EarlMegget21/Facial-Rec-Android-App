...
import com.epsi.mspr.archi.repositories.IDRepositoryHttp;
...
public abstract class BindModule {
     ...
     */
    @Binds
    @Singleton //on ne peut PAS mettre @Singleton sur la classe IDRepositoryHttp ou IDRepository et ne pas le mettre ici, Dagger ne le considèrera pas comme un Singleton
    ...
    public abstract IDRepository provideTwitterRepository(IDRepositoryHttp repo);
