...
import com.backelite.mspr.archi.view_models.TweetListViewModel;
...
//    public abstract void inject(TweetListViewModel tweetListViewModel); //on doit spécifier l'Activity dans laquelle on injecte les attributs (Presenter, etc..) de l'AppModule dans les attributs portant @Inject de l'activité en question, on doit donc faire une methode par vue dans laquelle on inject
